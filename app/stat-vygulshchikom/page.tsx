...
const selection = [
  { title: "Тщательно проверяем", desc: "Изучаем документы, личную информацию и соцсети — безопасность превыше всего." },
  { title: "Обучаем и тестируем", desc: "Проходите курс, разработанный вместе с кинологами, и тест по правилам безопасности." },
  { title: "Практическое занятие", desc: "Финально проверяем навыки на практике, с настоящей прогулкой." },
  { title: "Допускаем к заказам", desc: "Только после всех этапов вы получаете первый заказ. В команду попадают не все." },
];
    ...
    <>
      ...
      <section className="container-page mt-16 md:mt-24">
        <div className="text-center">
          <p className="text-2xl font-bold text-brand-500 md:text-3xl">Только 2 из 10 попадают в команду</p>
